						...
						<div class="box box-primary">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<form:select class="form-control" path="departmentName">
										<c:forEach items="${listDepartment}" var="d">
											<form:option value="${d.deName}">${d.deName}</form:option>
										</c:forEach>
									</form:select>
								</div>
								<div class="form-group">
						...
						<div class="box box-primary">
							<div class="box-body">		
								<div class="form-group">
									...
									<form:input type="text" class="form-control"
										id="exampleInputPassword1" placeholder="Enter job" path="job" />
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Job ID</label>
									<form:input type="text" class="form-control"
										id="exampleInputPassword1" placeholder="Enter job" path="jobId" />
								</div>
								<div class="form-group">
