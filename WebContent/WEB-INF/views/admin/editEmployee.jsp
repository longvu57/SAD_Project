							...
							<div class="box-body">
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Department</label> <form:input
										type="text" class="form-control" id="exampleInputEmail1"
										placeholder="Enter department" value="${e.departmentName}" path="departmentName"/>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="box-body">
								...
								<div class="form-group">
									<label for="exampleInputPassword1">Department ID</label> <form:input
										type="text" class="form-control"
										id="exampleInputPassword1" placeholder="Enter department ID" value="${e.departmentId}" path="departmentId"/>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="exampleInputPassword1">Job</label> <form:input
										type="text" class="form-control"
										id="exampleInputPassword1" placeholder="Enter job" value="${e.job}" path="job"/>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Job ID</label> <form:input
										type="text" class="form-control" id="exampleInputEmail1"
										placeholder="Enter Job ID" value="${e.jobId}" path="jobId"/>
								</div>
							</div>
